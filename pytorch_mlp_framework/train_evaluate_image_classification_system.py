...
if args.block_type == 'conv_block':
    ...
    dim_reduction_block_type = ConvolutionalDimReductionBlock_BN
elif args.block_type == 'convBatchNormResCon_block':
    processing_block_type = ConvolutionalProcessingBlock_BN_ResCon
    dim_reduction_block_type = ConvolutionalDimReductionBlock_BN
else:
...
conv_experiment = ExperimentBuilder(network_model=custom_conv_net,
                                    ...
                                    learning_rate=args.learning_ratexs)  # build an experiment object
